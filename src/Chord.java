public class Chord {
	...
	private int[] getNotes(String name) {
		...
		case 3: notes[1] = notes[0] + 3; notes[2] = notes[1] + 3; notes[2] = notes[1] + 3;	break;
		case 4: notes[1] = notes[0] + 4; notes[2] = notes[1] + 3; notes[2] = notes[1] + 4;	break;
		case 5: notes[1] = notes[0] + 3; notes[2] = notes[1] + 4; notes[2] = notes[1] + 3;	break;
		case 6: notes[1] = notes[0] + 4; notes[2] = notes[1] + 3; notes[2] = notes[1] + 3;	break;
		case 7: notes[1] = notes[0] + 5; notes[2] = notes[1] + 6;	break;
		}
